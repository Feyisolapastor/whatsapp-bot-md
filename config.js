...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '21_7_3d1d_665f_97eb').trim(),
  DATABASE:
  ...
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE || 'true').trim(),
  ...
  REJECT_CALL: toBool(process.env.REJECT_CALL  || 'true').trim(),
